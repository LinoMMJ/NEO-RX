# Entrenamiento de Neo RX V1.3.4 en Kaggle
...
7. Guarda una versión del Notebook con sus outputs y descarga `neorx-v1.3.4-checkpoints.zip`, `manifests/`, `results/` y `runs/`.
